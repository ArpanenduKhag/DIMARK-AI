...
function changeOperationType() {
  ...
  if (occupation === "Online") {
    ...
    operationSelect.innerHTML =
      "<option value=''>Select</option><option value='App'>App</option><option value='Website'>Website</option><option value='Others'>Others</option>";
    ...
    // Add options for Others
    if (operationSelect.value === "Others") {
      var othersOptions = [
